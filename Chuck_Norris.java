 ...
 * <ul>
 * <li>The input message consists of ASCII characters (7-bit)</li>
 * <li>The encoded output message consists of blocks of 0</li>
 * <li>A block is separated from another block by a space</li>
 * <li>Two consecutive blocks are used to produce a series of same value bits (only 1 or 0 values):
 * <ul>
 * <li>First block: it is always 0 or 00. If it is 0, then the series contains 1, if not, it contains 0</li>
 * <li>Second block: the number of 0 in this block is the number of bits in the series</li>
 * </ul>
 * </li>
 * </ul>
 * 
 ...
 * <ul>
 * <li>0 0 (the first series consists of only a single 1)</li>
 * <li>00 0000 (the second series consists of four 0)</li>
 * <li>0 00 (the third consists of two 1)</li>
 * </ul>
 * So C is coded as: 0 0 00 0000 0 00
 * <p>
 * Second example, we want to encode the message CC (i.e. the 14 bits 10000111000011) :
 * <ul>
 * <li>0 0 (one single 1)</li>
 * <li>00 0000 (four 0)</li>
 * <li>0 000 (three 1)</li>
 * <li>00 0000 (four 0)</li>
 * <li>0 00 (two 1)</li>
 * </ul>
